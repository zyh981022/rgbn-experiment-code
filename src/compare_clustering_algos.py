...
cluster_centres_km,cluster_cnetres_hd,clusres_centres_sc = centroids_km.shape[0], centroids_hd.shape[0], centroids_sc.shape[0]

output = {}

# initializing rbfn model
#model1 = rbfn_model_tf(784, 10, cluster_centres_count, centroids_km[:cluster_centres_count, :], True)
model1 = rbfn_model_tf(784, 10, cluster_centres_km, centroids_km[:cluster_centres_km, :], True)
...
model2 = rbfn_model_tf(784, 10, clusres_centres_sc, centroids_sc[:clusres_centres_sc, :], True)
...
model3 = rbfn_model_tf(784, 10, cluster_cnetres_hd, centroids_hd[:cluster_cnetres_hd, :], True)
